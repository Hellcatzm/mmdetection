...
commands = [
    "./tools/dist_train.sh configs/carbonate/trident/trident_rcnn_r50_fpn_1x.py 2",
    "./tools/dist_train.sh configs/carbonate/trident/trident_rcnn_r50_fpn_1x_dcn.py 2",
    "./tools/dist_train.sh configs/carbonate/trident/trident_rcnn_r50_fpn_1x_dcnv2.py 2",
