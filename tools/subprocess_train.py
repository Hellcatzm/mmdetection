...
commands = [
    ...
    "./tools/dist_train.sh ./configs/carbonate/htc_libra_dconv2_c3-c5_gcse_x101_64x4d_pan.py 2"
    "./tools/dist_train.sh ./configs/carbonate/htc_libra_dconv2_c3-c5_se_x101_64x4d_pan_dice.py 2",
    "./tools/dist_train.sh ./configs/carbonate/htc_libra_dconv2_c3-c5_se_x101_64x4d_pan_ga.py 2",
